...
상태: private ops 분리 B안 승인. [별도 관리 EC2 사양·15개 자원 plan](management.md)을 사용자 승인 후 생성했다. GitHub App은 private ops에만 설치했다. [version-only 연결 단계](runtime/README.md)를 구현했으며 Terraform worker는 아직 활성화하지 않았다.
