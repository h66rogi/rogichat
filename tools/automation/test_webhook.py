...
class WebhookTests(unittest.TestCase):
    def setUp(self):
        ...
        self.payload = {'installation': {'id': 123}, 'repository': {'full_name': 'h66rogi/rogichat-ops', 'private': True, 'fork': False},
                        ...
                        'comment': {'body': 'atlantis version', 'user': {'id': 5}}}
    ...
    def test_only_exact_version_command_forwarded(self):
        self.assertEqual(self.check(self.payload)[0], 'version')
        for command in ['atlantis plan', 'atlantis apply', 'atlantis version -- -target=x', 'atlantis version\natlantis apply']:
