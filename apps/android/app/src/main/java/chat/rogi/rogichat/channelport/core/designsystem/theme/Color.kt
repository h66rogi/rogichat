...
// Meloming Brand Colors
val MelomingPrimary = Color(0xFF6366F1)
val MelomingPrimaryLight = Color(0xFF818CF8)
val MelomingPrimaryDark = Color(0xFF4F46E5)
val MelomingSecondary = Color(0xFF8B5CF6)
val MelomingTertiary = Color(0xFFEC4899)
...
fun parseHexColor(hex: String?): Color {
    if (hex == null) return MelomingPrimary
    return try {
