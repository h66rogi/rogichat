...
public final class ProviderAvatarDecoderTest extends TestCase {
    ...
    public void testGif87And89UseFirstStaticFrame() {
    ...
    public void testMalformedAndOversizedPixelsRejected() {
