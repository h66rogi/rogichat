...
struct AddScheduleView: View {
    ...
    init(channelId: Int, onComplete: (() -> Void)? = nil) {
        self.channelId = channelId
        self.onComplete = onComplete
        self._viewModel = StateObject(wrappedValue: AddScheduleViewModel(channelId: channelId))
    }
...
// MARK: - ScheduleType Extension for CaseIterable
extension ScheduleType: CaseIterable {
    static var allCases: [ScheduleType] {
        [.live, .collab, .off, .etc, .tbd]
    }
}
