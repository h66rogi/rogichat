...
struct AccountDeletionPresentation: Sendable, Identifiable, Equatable {
    ...
    var message: String {
        ...
        case .notSent, .preparing: return "탈퇴 요청을 보내지 못했어요. 이 기기의 상태를 먼저 확인해 주세요."
        case .unknown: return "탈퇴 요청의 접수 여부를 확인하지 못했어요. 서버에서 접수되었을 수 있어요."
        case .rejected: return "탈퇴 요청이 거절됐어요. 앞선 다른 요청의 접수 여부를 확인한 것은 아니에요."
        }
    }
}
