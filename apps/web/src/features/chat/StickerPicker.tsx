...
export function StickerPicker(props: { submitBlocked?: boolean | undefined; target: ChatComposerTarget; onSubmit: (submission: ChatComposerSubmission) => ChatSubmitResult | Promise<ChatSubmitResult>; onClose: () => void }) {
...
function CatalogPicker({ catalog, roomId, target, onSubmit, onClose, submitBlocked }: { submitBlocked?: boolean | undefined; catalog: StickerCatalog; roomId: string; target: ChatComposerTarget; onSubmit: (submission: ChatComposerSubmission) => ChatSubmitResult | Promise<ChatSubmitResult>; onClose: () => void }) {
