...
try {
  ...
  stage = 'tests';
  testProcess = spawn(process.execPath, ['--test', '--test-concurrency=1', 'test/integration/mysql.test.mjs', 'test/integration/transactions.test.mjs', 'test/integration/auth.test.mjs', 'test/integration/community.test.mjs', 'test/integration/messages.test.mjs', 'test/integration/messages-crash.test.mjs', 'test/integration/jobs.test.mjs', 'test/integration/realtime.test.mjs', 'test/integration/sync.test.mjs'], {
    stdio: 'inherit', env: {
