...
export const publicationDocs = {
  publish: () => contract({ id: 'publishMessage', summary: '스트리머가 메시지 공개본 생성 요청', auth: 'write', params: ['roomId', 'messageId'], body: empty, status: 202, response: receipt,
    description: '방 소유 스트리머 권한이 필요합니다. 현재 TEXT 원본만 지원합니다. 202는 처리 접수이며 preparing/published 상태를 조회합니다. 팬의 추가 동의 플래그는 없습니다. 원본 삭제 시 연결 공개본 접근도 회수합니다.', errors: [400, 401, 403, 404, 413, 429] }),
