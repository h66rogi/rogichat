...
export const roomDocs = {
  ...
  leave: () => contract({ id: 'leaveRoom', summary: '방 퇴장 또는 방장 방 닫기', auth: 'write', params: ['roomId'], body: empty, status: 204, description: '참여자가 나가면 본인의 참여만 끝납니다. 방장이 나가면 방이 닫히고 모든 참여자의 접근이 끝납니다.', errors: [400, 401, 403, 404, 409, 413] }),
