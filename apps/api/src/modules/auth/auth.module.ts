    ...
    return {
      ...
      providers: [
        ...
        options.sessions === undefined ? {
          provide: Sessions, inject: [Transactions, AUTH_CONFIG],
          useFactory: (transactions: Transactions, config: AuthConfig) => new Sessions(transactions, config.audience, config.key),
