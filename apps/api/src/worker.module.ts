...
export class WorkerModule {
  ...
  static production(settings: RuntimeSettings): DynamicModule {
    ...
    return { module: WorkerModule, imports: [infrastructure, AppleLifecycleModule.register(infrastructure, settings.auth), JobsModule.register(infrastructure, 'worker'), PublicationsCoreModule, DeletionModule.register(infrastructure, settings.deletion, true),
