import { Jobs, JobFailure, JOB_PURPOSES } from './jobs.js';
import type { JobLease, JobPurpose } from './jobs.js';
...
export class WorkerLoop {
  ...
  constructor(transactions: Transactions, private readonly lifecycle: LifecycleState,
    ...
    this.jobs = new Jobs(transactions, 'worker');
